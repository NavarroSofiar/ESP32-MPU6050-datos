...
//*********** MQTT CONFIG **************
//**************************************
const char *mqtt_server = "34.95.237.241";
const int mqtt_port = 1883;
const char *mqtt_user = "admin";
const char *mqtt_pass = "public";
const char *root_topic_subscribe = "IoT/ACX";
const char *root_topic_publish = "IoT/ACX";
...
//String temperatura = "/" + String(root_topic_subscribe) + "/" + "temperatura"; 
...
tiempoAnterior = tiempoActual; 
  ...
  if (currentMillis - previousMillis >= 200) { //envia la temperatura cada 10 segundos
    ...
    itoa( AcX,AcX_char,10);
    Serial.println("Enviando: [" +  String(AcX) + "] " );
    client.publish(root_topic_publish, AcX_char);
  }
